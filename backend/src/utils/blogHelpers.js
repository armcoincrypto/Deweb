...
export function toBlogPostListItem(row) {
  ...
  return {
    ...
    imageQualityScore: aiMeta.imageQualityScore ?? null,
    regenerationCount: aiMeta.regenerationCount ?? null,
    rejectedFromPostId: aiMeta.rejectedFromPostId || null,
    rejectedFromPostTitle: aiMeta.rejectedFromPostTitle || null,
    scheduledPublishAt: row.scheduled_publish_at || null,
    approvedAt: row.approved_at || null,
    publishMode: row.publish_mode || null,
    wordCount,
