...
export const serviceBanners: ServiceBanner[] = [
  {
    ...
    pricing: "From $500",
    timeline: "2–4 weeks",
    benefits: ["Scalable growth", "Conversion-focused storefronts", "Seamless integrations"],
    visual: "shopify",
    featured: true,
    accent: "#95BF47",
  ...
  },
  {
    ...
    icon: "🤖",
    deliverables: ["24/7 Support", "Lead Gen", "CRM Integration", "Custom conversation flows"],
    pricing: "From $300",
    timeline: "1–3 weeks",
  ...
  },
  {
    ...
    pricing: "From $2500",
    timeline: "6–12 weeks",
    benefits: ["Monetize transactions", "Marketplace specialists", "Secure environment"],
    visual: "marketplace",
  ...
  },
  {
    ...
    pricing: "From $400",
    timeline: "Ongoing",
    benefits: ["Organic traffic", "SEO-friendly structure", "Data-informed growth"],
    visual: "seo",
