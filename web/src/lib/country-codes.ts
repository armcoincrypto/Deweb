...
export const COUNTRY_CODES = [...RAW_COUNTRY_CODES].sort((a, b) =>
  a.name.localeCompare(b.name)
);

export const DEFAULT_COUNTRY =
  COUNTRY_CODES.find((c) => c.iso === "AM") ?? COUNTRY_CODES[0];

const DIAL_MATCH_ORDER = [...COUNTRY_CODES].sort(
...
export function formatPhoneNumber(country: CountryCode, national: string): string {
