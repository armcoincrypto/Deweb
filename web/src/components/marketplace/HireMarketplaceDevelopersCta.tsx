...
type HireMarketplaceDevelopersCtaProps = {
  title: string;
  description: string;
  primaryLabel: string;
...
export function HireMarketplaceDevelopersCta({
  title,
  description,
  primaryLabel,
  secondaryLabel,
}: HireMarketplaceDevelopersCtaProps) {
  return (
    <section className="mt-12 overflow-hidden rounded-2xl border border-deweb-cyan/25 bg-gradient-to-br from-deweb-cyan/15 via-[#0a1628] to-purple-900/20 p-8 text-center sm:p-12">
      ...
      <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
        ...
        <GlowButton href="/services/marketplace-development" variant="ghost">
          {secondaryLabel}
        </GlowButton>
      </div>
    </section>
