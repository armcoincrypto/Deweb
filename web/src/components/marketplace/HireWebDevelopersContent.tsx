...
import { HireWebDevelopersCta } from "./HireWebDevelopersCta";

export async function HireWebDevelopersContent() {
  ...
  return (
    <section
      ...
      aria-labelledby="hire-web-dev-heading"
    >
      <div className="space-y-10">
        <div>
          <h2 id="hire-web-dev-heading" className="text-2xl font-bold text-white">
            {t("whyHireTitle")}
          </h2>
