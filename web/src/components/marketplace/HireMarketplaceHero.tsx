...
type HireMarketplaceHeroProps = {
  namespace:
    | "marketplace.hireTelegramBotDevelopers"
    | "marketplace.hireAiAutomationSpecialists";
};

export async function HireMarketplaceHero({ namespace }: HireMarketplaceHeroProps) {
      ...
      <div className="container-narrow relative z-10 px-4 pt-[var(--navbar-offset)] sm:px-6 lg:px-8 lg:pt-8">
        <nav aria-label="Breadcrumb" className="pb-2 text-sm text-white/45">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li>
              <Link href="/marketplace" className="transition-colors hover:text-deweb-cyan">
