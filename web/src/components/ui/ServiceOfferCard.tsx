...
export function ServiceOfferCard({
  ...
  return (
    <GlassCard glow delay={delay} tilt className="h-full">
      <div className="flex h-full flex-col p-6 sm:p-8">
        <div
          className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl text-2xl transition-transform duration-300"
          style={{
